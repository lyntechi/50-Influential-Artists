...
/* Task 2: There is a typo in your dataset 😱 The 9th artist, Vincent Van Gogh is currently Vincent Van Dough. Use an array method to fix this issue
...
// function lotsOfArt(artistsArray){
  ...
  function lotsOfArt(artists){
    let newArray = artists.filter(function(items){
    return items.paintings >= 100;
    });
